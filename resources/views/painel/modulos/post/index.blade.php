...
@section('conteudo')
    <div class="title-pg">
        <h1 class="title-pg">Listagem das Posts</h1>
    </div>
        ...
        <table class="table table-striped">
            ...
            @forelse($datas as $category)
                <tr>
                    ...
                    <td>
                        <a href="{{route('posts.show', $category->id)}}" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></a>
                        <a href="{{route('posts.edit', $category->id)}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
